...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    carbonSmartCTAAuthUserSubject.add(
      CarbonSmartCTAAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<CarbonSmartCTAAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  CarbonSmartCTAAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = CarbonSmartCTAAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    carbonSmartCTAAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
CarbonSmartCTAAuthUser? currentUser;
