...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0EB529);
  late Color secondary = const Color(0xFF353847);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF060815);
  late Color secondaryText = const Color(0xFF353847);
  late Color primaryBackground = const Color(0xFFC0C2CA);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0xFF1F212B);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF0EB529);
  late Color warning = const Color(0xFFE58617);
  late Color error = const Color(0xFFE61D1D);
  late Color info = const Color(0xFF304EED);
}
